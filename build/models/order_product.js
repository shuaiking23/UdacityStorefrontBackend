...
var OrderProductStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "SELECT id, order_id, product_id, quantity, \n                    created, last_update\n                FROM order_products\n                WHERE NOT historic";
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not get order products. Error: ".concat(err_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrderProductStore.prototype.show = function (op) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not find product ".concat(op.product_id, " from order ").concat(op.order_id, ".\n                Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    OrderProductStore.prototype.create = function (op) {
        return __awaiter(this, void 0, void 0, function () {
            var exists_sql, insert_sql, update_sql, conn, result, exists, sql, order_product, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 4:
                        err_3 = _a.sent();
                        throw new Error("Could not add product ".concat(op.product_id, " to order ").concat(op.order_id, ".\n                Error: ").concat(err_3));
