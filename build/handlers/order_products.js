...
var opStore = new order_product_1.OrderProductStore();
var oStore = new order_1.OrderStore();
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order_products;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, opStore.index()];
            case 1:
...
var destroy = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order_product, productOrder, auth_status, deleted, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 4, , 5]);
                return [4 /*yield*/, oStore.show(req.body.id)];
            case 1:
                order_product = _a.sent();
                return [4 /*yield*/, oStore.show(order_product.order_id)];
            case 2:
                productOrder = _a.sent();
                auth_status = (0, common_1.token_check)(req.headers.token, productOrder.user_id);
                if (auth_status != 'OK') {
                    res.status(401).json(auth_status);
                    return [2 /*return*/];
                }
                return [4 /*yield*/, opStore["delete"](req.body.id)];
            case 3:
                deleted = _a.sent();
                res.json(deleted);
                return [3 /*break*/, 5];
